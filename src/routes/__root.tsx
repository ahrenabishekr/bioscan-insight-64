...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ChemoSense — Clinical Diagnostics" },
      { property: "og:description", content: "Rapid pathogen detection via chemosensor biomarkers." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "ChemoSense" },
      { name: "twitter:description", content: "Rapid pathogen detection via chemosensor biomarkers." },
    ],
    links: [
      {
        rel: "stylesheet",
